"""Motor de análisis principal de EdgeBot-IA-V2"""
...
class EdgeBotAnalyzer:
    ...
    def obtener_partidos_nuevos(self):
    ...
    def analizar_partido(self, partido_id, partido_str):
